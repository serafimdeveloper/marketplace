<div class="alertbox" id="jq-info-seller">
        ...
        <div class="alertbox-content">
            ...
            <div class="pop-user-info">
                <div class="pop-user-info-action">
                    <a class="btn btn-small btn-popmartin fl-right btn-delete-seller" data-token="{{csrf_token()}}" data-id="{{$result->id}}" style="margin-left: 10px;"><i class="fa fa-trash"></i> remover usuário</a>
                    <a class="btn btn-small btn-popmartin fl-right btn-unlock-seller" data-id="{{$result->id}}">{!! ($result->active) ? '<i class="fa fa-unlock"></i> bloquear vendedor' : '<i class="fa fa-unlock"></i> desbloquear vendedor'!!} </a>
                </div>
                            ...
                            <div class="colbox">
                                ...
                                <div class="colbox-4">
                                    <div class="pop-info-user">
                                        ...
                                        <span><a href="{{url('imagem/vendedor/'.$result->proof_address)}}" class="btn btn-smallextreme btn-popmartin"
                                                 target="_blank">ver documento</a></span>
                                    </div>
                                </div>
                                <div class="colbox-4">
                                    <div class="pop-info-user">
                                        <p>Comissão (%)</p>
                                         {!! Form::open(['route' =>['account.report.sellers.update', $result->id],'id'=>'form-commission', 'method' => 'PUT']) !!}
                                            <label>
                        ...
                        <div class="accordion-content">
                            ...
                            <div class="colbox">
                                ...
                                <div class="colbox-full">
                                    <div class="pop-info-user">
                                        <p>Endereço</p>
                                        @if($address = $result->store->address)
                                            <span>{{ $address->public_place.' | '.$address->number }}
                                                {{ ($address->complements) ? ' ('.$address->complements.') |' : '| ' }}
                                                {{ $address->neighborhood.' | '.$address->city.' | '.$address->state.' | ' }}
                                                {{ $address->zip_code }}</span>
