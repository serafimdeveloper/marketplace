        ...
        <header class="pop-title">
            ...
            <div class="pop-tile-menu">
                <div class="form-modern">
                    {!! Form::model($request_status, ['class' => 'orderTable', 'route' => 'account.requests', 'method' => 'get']) !!}
        ...
        <!-- TABLE -->
            <table class="table table-action">
                ...
                @foreach($requests as $order)
                        ...
                        <td class="t-status t-{{ $order->request_status->trigger }}">{{ $order->request_status->description }}</td>
                        <td class="txt-center"><a href="/account/requests/{{ $order->id }}"
