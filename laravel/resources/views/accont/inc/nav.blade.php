...
<nav class="panel-nav">
     <div class="panel-nav-acsess">
         ...
         <ul>
             ...
             <li><a href="{{route('accont.messages.all',['type'=>'user'])}}"{!! url()->current() ==  route('accont.messages.all',['type'=>'user']) ? ' class="current_rout"' :  ''!!}>mensagens {!! (notification_message_client() >= 1 ? '<span class="fl-right padding05-10 radius bg-blue-gray" style="margin-top: -5px;">'.notification_message_client().'</span>' : '') !!}</a></li>
         </ul>
     </div>
    @can('vendedor')
        <div class="panel-nav-acsess">
             ...
             <ul>
                 ...
                 <li><a href="{{route('accont.messages.all',['type'=>'store'])}}"{!! url()->current() ==  route('accont.messages.all',['type'=>'store']) ? ' class="current_rout"' :  ''!!}>mensagens {!! (notification_message_salesman() >= 1 ? '<span class="fl-right padding05-10 radius bg-blue-gray" style="margin-top: -5px;">'.notification_message_salesman().'</span>' : '') !!}</a></li>
             </ul>
         </div>
    @endcan
    @cannot('vendedor')
    ...
    @can('admin')
         <div class="panel-nav-acsess">
             ...
             <ul>
                 ...
                 <li><a href="{{route('accont.report.salesman')}}"{!! url()->current() ==  route('accont.report.salesman') ? ' class="current_rout"' :  ''!!}>vendedores {!! (notification_sales(0) >= 1 ? '<span class="fl-right padding05-10 radius bg-blue-gray" style="margin-top: -5px;">'.notification_sales(0).'</span>' : '') !!}</a></li>
                 ...
                 <li><a href="{{route('accont.report.notifications')}}"{!! url()->current() ==  route('accont.report.notifications') ? ' class="current_rout"' :  ''!!}>notificações {!! (notification_sales(0) >= 1 ? '<span class="fl-right padding05-10 radius bg-blue-gray" style="margin-top: -5px;">'.notification_sales(0).'</span>' : '') !!}</a></li>
