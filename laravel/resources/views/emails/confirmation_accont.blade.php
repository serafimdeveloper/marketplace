<style type="text/css">
    .btn-confirm{ padding: 5px 15px; font-weight: bold; background: #800000; color:#fff; }
</style>
<div style="text-align: justify; font-size: 14px; font-family: Arial,Helvetica,Sans-Serif">
    ...
    <a class="btn-confirm" href="{{route('auth.confirm',[$user->email, $user->confirm_token])}}" target="_blank">Confirme sua Conta</a>
    <br/>
    <p>
        Atenciosamente,<br />
        Equipe Pop Martin.
