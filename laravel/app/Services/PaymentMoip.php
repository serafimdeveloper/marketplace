...
class PaymentMoip
{
    ...
    function mount(){
        ...
        $this->moip->addComission('Comissão de venda Pop Matin', env('MOIP_COMISSION'), ($this->store->salesman->comission ? $this->store->salesman->comission : env('MOIP_COMISSION_DEFAULT')) - 6.9, true, false);
